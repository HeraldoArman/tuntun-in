...
export function Audience() {
  return (
    ...
    >
      {/* Decorative mascot — floating top-left, balancing the layout */}
      <Mascot
        className="absolute top-8 left-4 z-0 hidden h-40 w-40 -rotate-12 drop-shadow-2xl sm:left-10 md:block lg:h-56 lg:w-56"
        name="robot_16"
      />
